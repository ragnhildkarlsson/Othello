...
public class BoardFactory {
	 ...
	 * 
	 * @param oldBoard The old board to swap nodes on
	 * @param nodesToSwap Which nodes from the old board that should be swapped
	 * @param playerIDToSwapTo player ID to set for the nodes that will be swapped
	 * @return a board with nodes swapped according to nodesToSwap
	 * @throws IllegalArgumentException if the old board size is different from the board size generated by this factory
	 */
	...
	/**
	 * Search for a node with a given x and y coordinate in nodes, return null if not found.
	 * 
	 * @param nodes the nodes to search in
	 * @param xCoordinate the x coordinate to find
	 * @param yCoordinate the y coordinate to find
