...
public class SimpleOthello implements Othello {
	 ...
	 */
	protected SimpleOthello(String id, Collection<Player> players, BoardAdapter board,
			GameModelFactory gameModelFactory, Score score, RulesAdapter rules, MoveCoordinator moveCoordinator) {
