...
/**
 * A SilentRunner is responsible for running games between computer players, and then returning the result of the match,
 * without producing any output regarding the games while running.
 *
 */
